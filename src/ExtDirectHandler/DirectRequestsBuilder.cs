...
namespace ExtDirectHandler
{
	...
	{
		public DirectRequest[] Build(TextReader content, NameValueCollection formData, IDictionary<string, HttpPostedFile> files)
		{
		...
		public DirectRequest[] BuildFromFormData(NameValueCollection form, IDictionary<string, HttpPostedFile> files)
		{
